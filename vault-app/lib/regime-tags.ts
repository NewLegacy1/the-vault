 ...
 *          strategies/knowledge/quant/vol-regime-dependence-setup-frequency.md
...
/**
 * Parse calendar time strings ("10:00", "1000", "9:55") to HHMM integer.
...
export function release10FromEventTimes(times: Array<string | undefined | null>): boolean {
  return times.some((t) => {

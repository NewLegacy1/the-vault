...
weeks_to_payout_p50: 37.5
expected_accounts: 1.8
tags: [cohort, prb, eval, monte-carlo, lab]
created: "2026-07-20T21:21:33.313Z"
dataset: "regime-gate-v0"
mc_max_trades: 220
payout_buffer: 2000
mc_engine_version: 2
mc_rule_pack: ["eod_trail","consistency_total"]
firm_mc: {"tpt50":{"passPct":56.9,"bustPct":43.2,"payoutPct":54.2,"medianNetPerAccountUsd":814,"expectedNetPerAccountUsd":944,"medianWithdrawnUsd":3762,"mcMode":"eval","weeksToPassP50":22.5,"weeksToPayoutP50":36,"passAt":4000,"trailingDD":2000,"consistencyPct":50,"firmName":"TPT $50K Test → PRO"},"topstep50":{"passPct":0,"bustPct":38.9,"payoutPct":0,"medianNetPerAccountUsd":-98,"expectedNetPerAccountUsd":-98,"medianWithdrawnUsd":0,"mcMode":"eval","weeksToPassP50":null,"weeksToPayoutP50":null,"passAt":3000,"trailingDD":2000,"consistencyPct":50,"firmName":"Topstep $50K (Combine → XFA)"},"alpha-zero-50":{"passPct":62.5,"bustPct":37.5,"payoutPct":58,"medianNetPerAccountUsd":734,"expectedNetPerAccountUsd":479,"medianWithdrawnUsd":1350,"mcMode":"eval","weeksToPassP50":16.5,"weeksToPayoutP50":30,"passAt":3000,"trailingDD":2000,"consistencyPct":0,"firmName":"Alpha Zero $50K Eval"},"apex50-eod":{"passPct":59.9,"bustPct":40.1,"payoutPct":55.7,"medianNetPerAccountUsd":1204,"expectedNetPerAccountUsd":579,"medianWithdrawnUsd":1500,"mcMode":"eval","weeksToPassP50":15,"weeksToPayoutP50":27,"passAt":3000,"trailingDD":2000,"consistencyPct":0,"firmName":"Apex $50K EOD Trail"}}
...
payout_given_pass_pct: 95.8
median_withdrawn_usd: 3738
expected_net_per_account_usd: 964
expected_usd_per_calendar_week: 26
recycle_pct: null
---
...
|--------|-------|
| **E[$ / calendar week]** | **$26** |
| E[$ / account] after fees | $964 |
| Pass → P(payout given pass) | 56.5% → 95.8% |
| Median trader withdraw | $3738 |
| Median weeks to payout | 37.5 |
| Bust rate | 43.5% |
...
| Net after fees (median path) | $2,400 |

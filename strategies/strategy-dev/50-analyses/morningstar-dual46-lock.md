...
| Instrument | **MNQ stays** (07-18 research): under fixed-$ risk with 5–35-pt stops, 1 NQ forces $200–700/trade (8–28% of a $2.5k buffer); micro commission penalty ~$8–12/trade is trivial vs one forced over-risk NQ loss. Revisit only when avg size >15–20 MNQ (then 1-NQ-core + MNQ-flex hybrid) — [[../../knowledge/quant/mnq-vs-nq-instrument-comparison\|instrument research]] |

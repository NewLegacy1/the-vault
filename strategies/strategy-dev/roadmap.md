...
**Phase 1 done** ([[phase1-autopsy-a0a-d1]]): `regime-gate-v0` = STAND_DOWN Jul+Oct.  
**Next:** Phase 2 Lab MC on gated CSVs. Track B deferred. Historical tracks below remain the backlog archive.
...
|---|---|---|---|---|
| 4.1 | **Macro @$400 + BE@2R** (M0→M1→M2) | BE kills trail busts; M2 restores frequency | `Macro_Model_v2` · Lab **M-series** | **KILL — M0≡M1 (BE never armed); M2 21% pass / 77% bust** |
